...
public class UserPlant implements Serializable {
    ...
    private boolean careNeeded;
    private long daysToClosestAction;
    ...
    public long getDaysToClosestAction() {
    ...
    public void setCareNeeded(boolean careNeeded) {
        this.careNeeded = careNeeded;
    }

    public void setDaysToClosestAction(long daysToClosestAction) {
        this.daysToClosestAction = daysToClosestAction;
    }
