...
import static com.grzeluu.lookupplant.utils.Constants.WRITE_EXTERNAL_STORAGE;
...
import static com.grzeluu.lookupplant.utils.TimeUtils.getTimestamp;
...
import com.grzeluu.lookupplant.core.add.AddContract;
import com.grzeluu.lookupplant.core.add.AddPresenter;
...
import com.grzeluu.lookupplant.utils.notification.NotificationUtils;
...
public class AddPlantFragment extends BaseFragment implements AddContract.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenter = new AddPresenter(this, requireContext());
    ...
    private void initButtons() {
        ...
        binding.toolbar.btAddPlant.setOnClickListener(v -> {
            ...
            presenter.addPlant(
                    ...
                    binding.etLatinName.getText().toString(),
